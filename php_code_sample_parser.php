<?php namespace App\WasSiteName;

use App\WasSiteName\Parser\ParserFIT;
use App\WasSiteName\Parser\ParserTCX;
use App\WasSiteName\Parser\ParserGPX;
    	...
    	if ($request->hasFile('file')) {
        	...
        	if ( strtolower($ext) == 'fit' ) {
            	if (\App::environment() == 'local') {
                	exec('java -jar /vagrant/code/resources/sdk/java/FitCSVTool.jar -b /vagrant/code/public/uploads/rides/' . $newFileName.' /vagrant/code/public/uploads/rides/' .$fileName.'.csv' );
            	} else {
                	exec('java -jar /var/www/web-site/resources/sdk/java/FitCSVTool.jar -b  /var/www/web-site/public/uploads/rides/' . $newFileName.' /var/www/web-site/public/uploads/rides/' .$fileName.'.csv');
            	}
        	}
